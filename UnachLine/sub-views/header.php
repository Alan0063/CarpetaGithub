...
.btn-login {
    ...
    <body>        
        ...
        <h5 style="display: inline-block; margin: 0; vertical-align: middle;">UnachAir</h5>
        <img src="assets/images/plane-avion.png" alt="Logo" width="80" height="50" style="display: inline-block; vertical-align: middle;">


        <a class="navbar-brand" href="index.php"><h5>Inicio</h5>          
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">     
                <li class="nav-item">
                    <a class="nav-link" href="reservar.php"><h5> reservar</h5>
            ...
            if(isset($_SESSION['userId'])) {
                ...
                <div class="dropdown-menu w-75" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item " href="login.php">Pasajero</a>
