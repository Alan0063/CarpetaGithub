...
<main>
    ...
    <div class="col-md-12 main-col">
        <h1 class="text-center text-secondary">Detalles del Pasajero</h1>  
        ...
        <?php for($i=1;$i<=$passengers;$i++) {
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="firstname'.$i.'">Primer Nombre</label>
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="midname'.$i.'">Segundo Nombre</label>
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="mobile'.$i.'">Telefono</label>
