  ...
  if(!mysqli_stmt_prepare($stmt,$sql)) {
      ...
      if($row = mysqli_fetch_assoc($result)) {
          ...
          if($pwd_check == false) {
              ...
              $_SESSION['userUid'] = $row['nombre_usuario'];
...
<div class="container mt-0">
  <div class="row">
    <div class="col-md-3"></div>
      ...
      <h1 class="text-secondary text-center">Inicio de Sesion</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row">  
          ...
          <div class="col-10 mb-2">              
            <div class="input-group">
                <label for="id_usuario">Usuario/Correo</label>
        ...
        <div class="row mt-3">
          ...
          <a id="reset-pass" class="mr-5" href="reset-pwd.php"
              style="float: right !important;">Restablecer Contraseña</a>        
          </div>         
        </div>   
        <div class="row mt-4">
          <div class="col">
            <a href="register.php">
              <button type="button" class="btn btn-sm rounded-0 btn-info mt-3">
                <div style="">
                <i class="fas fa-user-plus text-light"></i> Registrarse
                </div>
              </button>
            </a> 
          </div> 
          <div class="col">
            <button name="login_but" type="submit" 
              ...
              <div style="">
              <i class="fa fa-lg fa-arrow-right"></i> Ingresar
              </div>
            </button>
          </div>       
        </div>       
