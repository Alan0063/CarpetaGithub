...
if (isset($_POST['signup_submit'])) {
    ...
    // Validación de las contraseñas
        ...
        $username_sql = 'SELECT nombre_usuario FROM usuario WHERE nombre_usuario=?';
        $email_sql = 'SELECT email FROM usuario WHERE email=?';
        ...
        // Autenticación del usuario inmediatamente después del registro
