...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center ">Pagar Boleto</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <span class="invalid-feedback">Ingrese un número de tarjeta válido de 12 a 16 dígitos</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="cc-exp" class="control-label mb-1">Fecha de Expiracion</label>
                            <input id="cc-exp" name="cc-exp" type="tel" class="form-control cc-exp" required placeholder="MM / YY" autocomplete="cc-exp">
                            <span class="invalid-feedback">Introduzca la fecha de vencimiento</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Ingrese el código de 3 dígitos en la parte posterior</span>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                    <span class="fa fa-question-circle fa-lg" data-toggle="popover" data-container="body" data-html="true" data-title="CVV" 
                                    data-content="<div class='text-center one-card'>El código de 3 dígitos que se encuentra en el reverso de la tarjeta.<div class='visa-mc-cvc-preview'></div></div>"
