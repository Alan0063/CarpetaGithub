...
if(isset($_POST['del_airlines']) and isset($_SESSION['adminId'])) {
  $airline_id = $_POST['id_aerolinea'];
  $sql = 'DELETE FROM aerolinea WHERE id_aerolinea=?';
...
<main>
    <?php if(isset($_SESSION['adminId'])) { ?>
      <div class="container-md mt-2">
        <h1 class="display-4 text-center text-secondary">LISTA DE AEROLÍNEAS</h1>
        <table class="table table-sm table-bordered">
          ...
          <tbody>
            ...
            <?php
            $cnt=1;
            $sql = 'SELECT * FROM aerolinea ORDER BY id_aerolinea ASC';
            $stmt = mysqli_stmt_init($conn);
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              <tr class='text-center'>                  
                ...
                <form action='list_airlines.php' method='post'>
                  <input name='airline_id' type='hidden' value=".$row['id_aerolinea'].">
