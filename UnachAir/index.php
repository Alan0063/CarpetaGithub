		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Viaje Redondo</span></li>
					<li class="resp-tab-item"><span>Solo Ida</span></li>
				</ul>	
					...
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								<option value="0" selected disabled >Salida</option>';
							...
							<div class="clear"></div>
							<input type="submit" value="Buscar Vuelos" name="search_but">
						</form>						
					</div>		
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class=" text-center">&copy; <?php echo date('Y')?> JoshuaAir<br><br></div>
	<!-- <p>----------</p> -->
