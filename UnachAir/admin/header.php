...
<html lang="es">
    <head>
        ...
        <title>Sistema de Reservas de Vuelos en Línea</title>          
        <link rel = "icon" href =  
  ...
  background-color: #316b83;
    ...
    <body>
        ...
        <nav class="navbar navbar-custom navbar-expand-lg navbar-dark bg-primary">
          <a class="navbar-brand text-light" href="index.php"><h4>UnachAir-Administrador</h4></a>
              ...
              if(isset($_SESSION['adminId'])) { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">
                      <h5 class="ml-2"> Panel de Control</h5>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" href="flight.php">
                      <h5 class="ml-2"> Crear Vuelo</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <div class="dropdown mt-2">
                      <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                        ...
                        <i class="fa fa-plus text-white"></i> Aerolíneas </td>
                      </button>  
