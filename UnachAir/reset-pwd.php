...
<div class="flex-container">
    <div class="login-form mt-5" style="height: 350px;">
        ...
        <div class="alert text-center alert-info mb-0" 
            ...
            Se le enviará un correo electrónico con las instrucciones sobre cómo restablecer la contraseña.
        </div>
            ...
            <div class="flex-container">             
                ...
                <div>
                    <input type="text" name="user_email" 
                        placeholder="Ingrese un correo de recuperacion" class="form-input" required>
                </div>
            </div>
            <div class="submit">
