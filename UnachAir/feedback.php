...
<div class="container mb-4">
  <h1> <i class="far fa-comment-alt"></i> Comentarios</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">¿Cuál fue tu primera impresión?
              cuando entraste al sitio web?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>¿Cómo te enteraste de nosotros?</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">¿Falta algo en esta página?</label>     
...
<footer>
	...
	<p class=" text-center">&copy; <?php echo date('Y');?> JoshuaAir</p>
</footer>